...
//Prints an excerpt from A Tale of Two Cities

#include <iostream>

int main() {
    std::cout << "A Tale of Two Cities\nBy Charles Dickens\n" << std::endl;
    std::cout << "It was the best of times, it was the worst of times, it was the age of wisdom, it was the age of"
